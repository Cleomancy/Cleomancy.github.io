...
progsfile="https://raw.githubusercontent.com/Cleomancy/Cleomancy.github.io/refs/heads/master/progs.csv"
aurhelper="yay"
repobranch="main"
export TERM=ansi
...
# dbus UUID must be generated for Artix runit. I usually use openRC but you never know.
